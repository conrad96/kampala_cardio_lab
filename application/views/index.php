...
<body>
    <!-- facebook API -->
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v5.0&appId=1572183289588771&autoLogAppEvents=1"></script>
    <!-- Preloader Start -->
    <div id="preloader">
        <div class="loader">
   ...
   <?php $this->load->view("shared/fun_facts"); ?>
    ...
    <!-- ***** Blog Area Start ***** -->
    <?php $this->load->view("shared/facebook_feed"); ?>
    <!-- ***** Blog Area End ***** -->
